...
import sys
sys.path.append('../')
sys.path.append('/home/nakama01/Desktop/belle_mere/libraries_wip/in_house')
...
while True :
	...
	temperature = water_temperature.read_celsius()
	#Set the IIC address
	...
	print("Temperature:%.1f ^C EC:%.2f ms/cm PH:%.3f " %(temperature,EC,PH))
	time.sleep(1.0)
